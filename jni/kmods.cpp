...
void Usage() {
    printf("UE4Dumper v0.21 <==> Made By Sharmamod\n");
    ...
    printf("  --package <packageName>             Package Name of App(Default: com.pubg.imobile)\n");
    printf("  --output <outputPath>               File Output path(Default: /sdcard/UE4Dumper)\n");
...
int main(int argc, char *argv[]) {
    int c;
    string outputpath("/sdcard/UE4Dumper");
    ...
    if (isBGMIndia()) {
        cout << "BGMI mode enabled. Offsets are read from CLI." << endl;
        cout << "  GNames raw: 0x" << setbase(16) << Offsets::GNames
             << " | GUObject: 0x" << Offsets::GUObjectArray
             << " | GWorld: 0x" << Offsets::GWorld << setbase(10) << endl;
    }
